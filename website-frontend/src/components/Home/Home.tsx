  ...
  const researchAreas = [
    {
      ...
      description:
        "Developing next-generation energy technologies for a sustainable future",
    ...
    },
    {
      ...
      description:
        "Designing practical approaches to address climate change challenges",
    ...
    },
    {
      ...
      description:
        "Advancing innovative clean tech solutions for industrial applications",
    ...
    },
    {
      ...
      description:
        "Optimizing resource usage through advanced research and innovation",
    ...
    },
    {
      ...
      description:
        "Developing sustainable approaches to water conservation and purification",
              ...
              <div className="mx-auto max-w-3xl text-center">
                <h1 className="text-3xl font-display font-bold tracking-tight sm:text-4xl lg:text-6xl leading-tight">
                  ...
                  <span className="bg-gradient-to-r from-accent-300 to-accent-500 bg-clip-text text-transparent relative">
                    Energy & Environment
                    <svg
                      className="absolute -bottom-1 left-0 w-full h-1 text-accent-400/60"
                      viewBox="0 0 100 10"
                      preserveAspectRatio="none"
                    >
                      <path
                        fill="currentColor"
                        d="M0,0 Q50,10 100,0 L100,10 L0,10 Z"
                      ></path>
                    </svg>
                  </span>
                </h1>
                <p className="mt-3 text-base sm:text-lg text-primary-100 max-w-2xl mx-auto leading-relaxed">
                  Advancing sustainable solutions for a cleaner, more efficient
                  future through cutting-edge research and innovation.
                </p>
              ...
              {researchAreas.map((area) => (
                ...
                >
                  ...
                  <div className="p-5 flex items-start gap-4">
                    <div
                      className={`p-3 rounded-lg flex-shrink-0 bg-${area.color}-100 text-${area.color}-600 group-hover:bg-${area.color}-500 group-hover:text-white shadow-sm transition-all duration-300 transform group-hover:scale-110 group-hover:rotate-3`}
                    >
                      {area.icon}
                    </div>
                    <div>
                      <h3
                        className={`text-base font-semibold mb-1 text-${area.color}-700 group-hover:text-${area.color}-600 transition-colors`}
                      >
                        {area.title}
                      </h3>
                  ...
                  <div className="flex flex-col md:flex-row h-full">
                    ...
                    <div className="relative md:w-1/3 h-40 md:h-auto overflow-hidden">
                      ...
                      <div className="absolute top-3 left-3">
                        <span
                          className={`inline-flex items-center gap-1 py-1 px-2 rounded-full text-xs font-medium
                          ${
