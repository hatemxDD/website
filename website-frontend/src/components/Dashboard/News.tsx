...
import EditNews from "./Sections/Edit/EditNews";
...
const initialArticles = [
  {
    ...
    content:
      "Our laboratory has been awarded a significant grant to continue our groundbreaking research in molecular biology.",
  ...
  },
  {
    ...
    content:
      "We are pleased to welcome three new researchers to our growing team of scientists.",
    author: "Dr. John Doe",
    publishDate: "2023-08-22",
    imageUrl:
      "https://images.unsplash.com/photo-1581093458791-9f3c3eecaf5f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
    published: true,
  },
  {
    id: "3",
    ...
    content:
      "Our lead researcher will be presenting our latest findings at the International Scientific Conference.",
    author: "Dr. Jane Smith",
    publishDate: "2023-10-05",
    imageUrl:
      "https://images.unsplash.com/photo-1577401239170-897942555fb3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
    published: false,
  },
];
...
const News: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (filterPublished !== null) {
      filtered = filtered.filter(
        (article) => article.published === filterPublished
      );
    }
  ...
  const renderContent = () => {
    switch (viewMode) {
      case "create":
        return (
          <CreateNews onCancel={handleCancel} onSuccess={handleCreateSuccess} />
        );
      case "edit":
        return (
          <EditNews
        ...
        return (
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="mb-2 flex items-center justify-between">
              ...
              <span
                className={`px-2 py-1 text-xs rounded-full ${article.published ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
              >
